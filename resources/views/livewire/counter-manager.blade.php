    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-6 mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Kelola loket pelayanan dan layanan yang ditangani</p>
            </div>
        ...
        @if ($showModal)
            <div class="fixed inset-0 z-50 overflow-y-auto" wire:loading.attr="class"
                ...
                <div class="flex min-h-screen items-center justify-center p-4">
                    <div
                        class="relative w-full max-w-lg transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 shadow-2xl">
