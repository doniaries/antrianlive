<div class="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 transition-colors duration-200">
    ...
    <div class="max-w-7xl mx-auto">
        <div class="mb-8">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kelola daftar loket pelayanan dan layanan yang ditangani</p>
        </div>
                        ...
                        @forelse ($counters as $counter)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $counter->name }}</div>
                                </td>
                                <td class="px-6 py-4">
                ...
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}" class="mt-5 space-y-6">
                            <div>
                                <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama Loket</label>
                                <input type="text" 
                                       wire:model="name" 
                                       id="name" 
                                       required
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Layanan yang Ditangani</label>
                                <div class="space-y-2">
                                    @foreach($services as $service)
                                        <div class="flex items-center">
                                            ...
                                            <label for="service-{{ $service->id }}" class="ml-2 block text-sm text-gray-700 dark:text-gray-300">
