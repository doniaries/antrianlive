                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    @php
                                        ...
                                        $statusClass =
                                            $statusColors[$counter->status] ??
                                            'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300';
                                        $statusLabel = $statusLabels[$counter->status] ?? 'Tidak Diketahui';
                                    @endphp
                                    <div class="flex flex-col items-center space-y-1">
                                        <span
                                            class="px-3 py-1 text-xs font-medium rounded-full {{ $statusClass }} whitespace-nowrap">
                                            {{ $statusLabel }}
                                        </span>
                                            ...
                                            if (!isLoading) {
                                                ...
                                                $wire.call('update', {{ $counter->id }})
                                                    .then((newStatus) => {
                                                        ...
                                                        window.dispatchEvent(new CustomEvent('counter-status-updated', { 
                                                            detail: { 
